...
function placeXOrO(squareNumber) {
    ...
    //The .some() methos is used to check each element of the selectedSquare array to 
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        new audio('./media/place_icon.mp3');
    ...
    function computersTurn() {
        ...
        while(!success){
            //A random number betweeen 0 and 8 is selected
...
function checkWinConditions() {
    ...
    // X 2, 5, 8 condition.
    else if (arrayIncludes('2X', '5X', '8X')) {drawWinLine(508, 50, 558, 558);}
    ...
    // X 2, 5, 8 condition.
    else if (arrayIncludes('2O', '5O', '8O')) {drawWinLine(508, 50, 558, 558);}
